package com.leicht.spring.service;
...
/*
 * @Service. This annotation marks the class as a stereotype that will be recognized as a bean 
 * by the Spring container, so it can be used, for example, with the @Autowired annotation.
 * */
@Service
